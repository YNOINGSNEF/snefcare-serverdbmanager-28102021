...
object ProcedureAntennas : OrangeProcedureDataFile() {
    ...
    override val procedureQuery = """
        ...
        SELECT MAX(E.EQPT_ID), C.SECTEUR, C.AZM_SYNOP, E.EQPT_CATALOG, E.MANUFACTURER, MAX(NOT(E.IS_PREV)) AS IS_INSTALLED, IFNULL(C.HBA, 0) AS A_HBA, IDS.SITE_ID
        FROM (
        ...
        GROUP BY C.SECTEUR, C.AZM_SYNOP, E.EQPT_CATALOG, E.MANUFACTURER, A_HBA, IDS.SITE_ID;
    """
}
