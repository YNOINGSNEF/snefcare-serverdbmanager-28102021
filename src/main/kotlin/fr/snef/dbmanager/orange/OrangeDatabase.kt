...
import fr.snef.dbmanager.isDebugEnabled
...
object OrangeDatabase : Database() {
    ...
    override val dbName get() = if (isDebugEnabled) "dump_orf_dev" else "dump_orf"
    ...
    override val filesToProcess = dumpFileNames.mapNotNull {
        Site.fromFileName(it)
    }
